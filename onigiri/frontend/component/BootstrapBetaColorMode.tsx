...
import { useBootstrapBetaColorMode } from "@/context/BootstrapBetaColorModeContext";

export default function BootstrapBetaColorMode() {
  // Use Context
  const { colorModeBeta, setColorModeBeta } = useBootstrapBetaColorMode();
      ...
      <ul className='dropdown-menu dropdown-menu-end shadow' aria-labelledby='bd-theme-text'>
        <li>
          <button
            ...
            aria-pressed='false'
            onClick={() => setColorModeBeta('light')}
          >
        ...
        <li>
          <button
            ...
            aria-pressed='true'
            onClick={() => setColorModeBeta('system')}
          >
